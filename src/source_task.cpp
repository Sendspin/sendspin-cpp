...
/// chain (stream -> send_chunk -> event wait) near 0.6 KB; the budget's remainder is headroom
/// for the ESP transport send path and platform differences, pending an on-target high-water
/// measurement
