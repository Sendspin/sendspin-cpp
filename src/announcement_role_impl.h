...
enum class AnnouncementStreamCallbackType : uint8_t {
    ...
    STREAM_END,       // Announcement stream discarded and ended (from cleanup / a failed start)
    ...
    OUTPUT_FINISHED,  // Task finished playing out the announcement (from the task thread)
};
